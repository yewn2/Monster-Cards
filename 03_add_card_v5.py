"""
Add card version 5
After a second round of testing by my father, I have realised that there is no confirmation of the
card being added to the database. This version of 'Add card' implements this.
"""
